...
interface UseTiltOptions {
  /** Max rotation in degrees. Bible caps card tilt at 8°. */
  max?: number;
...
/**
 * 3D tilt + optional mouse-tracked glow for cards. Extracted from GlassCard so
 * any surface can opt into the same "acknowledges the cursor" behaviour.
 */
